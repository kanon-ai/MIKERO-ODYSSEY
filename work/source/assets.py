...
def generate(out):
 ...
 # Static shop and sold-out counter in unused PCG slots 29/30.
 for t in (29,30):
  p=matrix(['###.#.#.###.###.','#...#.#.#.#.#.#.','###.###.#.#.###.','..#.#.#.#.#.#...','###.#.#.###.#...','................','################','##..##..##..##..','................','...##..####.....','....####.###....','...##..####.....','................','################','.##############.','..##........##..'])
  if t==30:
   for y in range(9,12):p[y]=[0]*16
  a=pcg(p,[15]*5+[1,10,6,1,7,7,7,1,10,6,10]);off=(128+t*4)*8
  static[off:off+32]=a[:32];static[2048+off:2048+off+32]=a[32:]
 key=matrix(['................','..####..........','.##..##.........','.##..##.........','..####..........','....##..........','....##..........','....##########..','....##########..','.........##.##..','.........##.##..','................','................','................','................','................'])
 a=pcg(key,[10,15,11,11,10,10,10,15,10,10,10,1,1,1,1,1]);off=252*8
 static[off:off+32]=a[:32];static[2048+off:2048+off+32]=a[32:]
